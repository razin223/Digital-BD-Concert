                            ...
                            <div class="auth-form-light text-left p-5">
                                ...
                                if (time() < strtotime($RegistrationEnd . "+06:00") && time() > strtotime($RegistrationStart . "+06:00")) {
                                    ...
                                    <form class="pt-3" method="post" action="<?php echo route('ka_group_registration') ?>">
                                        ...
                                        <div class="mt-3">
                                            <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="সাইন আপ" style="background-color:  #169400; border-radius: 10px"/>
                                        </div>
                                    </form>
                                    <?php
                                } else {
