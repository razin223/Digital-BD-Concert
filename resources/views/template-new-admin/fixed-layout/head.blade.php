...
<title>Digital Bangladesh Quiz | {{$title}}</title>
...
<!-- summernote -->
<link rel="stylesheet" href="{{asset('new_admin/plugins/summernote/summernote-bs4.css')}}">
<!--Select2 -->
<link rel="stylesheet" href="{{asset('new_admin/plugins/select2/css/select2.min.css')}}">
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">
<link rel="stylesheet" href="{{asset('new_admin/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css')}}">
...
<script src="{{asset('new_admin/plugins/summernote/summernote-image-title.js')}}"></script>
<!-- overlayScrollbars -->
<script src="{{asset('new_admin/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')}}"></script>
<!--select2 -->
<script src="{{asset('new_admin/plugins/select2/js/select2.min.js')}}"></script>
<!-- Toaster -->
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
<!-- AdminLTE App -->
<script src="{{asset('new_admin/dist/js/adminlte.js')}}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{asset('new_admin/dist/js/pages/dashboard.js')."?".time()}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{asset('new_admin/dist/js/demo.js')}}"></script>
<style>
    @font-face {
        font-family: 'Bangla';
        src: url("{{asset('Bangla_Font/SolaimanLipi_20-04-07.ttf')}}");
    }
</style>
