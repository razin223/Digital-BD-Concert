...
<html lang="en">
    <head>
        ...
        <title>ডিজিটাল বাংলাদেশ কুইজ: @yield('title','ইমেইল ভেরিফিকেশন ')</title>
        <!-- plugins:css -->
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <form class="pt-3" method="POST" action="<?php echo route('email_verify_resend') ?>">
                                    ...
                                    <div class="mt-3">
                                        <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="পুনরায় ভেরিফিকেশন ইমেইল পাঠান" style="background-color: #1B783C; border-radius: 10px"/>
                                    </div>
